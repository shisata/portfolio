...
export const Tech = ({name, logo, position, highlight, ...props}) => {
    ...
    return (
        <div id="tech-container" className={`w-[70vw] md:w-[50vw] h-[12vh] gap-x-[2vw] mt-[1rem] place-items-center justify-center flex transition ease-in duration-70 ${inView? highlight : 'text-text-muted'} ${position}`}>
